                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        <input type="hidden" class="form-control" name="id_jamaah" id="id_jamaah">
...
<script>
    $(document).ready(function() {
        ...
        function populateForm(data) {
            ...
            $("#no_passport").val(data.no_passport);
            $("#tgl_dikeluarkan").val(data.tgl_dikeluarkan);
            $("#tempat_dikeluarkan").val(data.tempat_dikeluarkan);
            $("#masa_berlaku").val(data.masa_berlaku);
            $("#nama_marham").val(data.nama_marham);
            $("#hub_marham").val(data.hub_marham);
